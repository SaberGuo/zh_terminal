...
#define wiznet_disable()          SPI_selectFourPinFunctionality(EUSCI_B3_BASE,EUSCI_SPI_ENABLE_SIGNAL_FOR_4WIRE_SLAVE )
#define wiznet_enable()         SPI_selectFourPinFunctionality(EUSCI_B3_BASE,EUSCI_SPI_PREVENT_CONFLICTS_WITH_OTHER_MASTERS)
